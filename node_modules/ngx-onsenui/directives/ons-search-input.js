...
var OnsSearchInput = /** @class */ (function () {
    ...
    OnsSearchInput_1 = OnsSearchInput;
    ...
    var OnsSearchInput_1;
    __decorate([
        Input('value'),
        __metadata("design:type", String)
    ], OnsSearchInput.prototype, "_value", void 0);
    __decorate([
        Output('valueChange'),
        __metadata("design:type", EventEmitter)
    ], OnsSearchInput.prototype, "_valueChange", void 0);
    __decorate([
        HostListener('blur'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], OnsSearchInput.prototype, "_onBlur", null);
    OnsSearchInput = OnsSearchInput_1 = __decorate([
        Directive({
            selector: 'ons-search-input',
            providers: [
                {
                    provide: NG_VALUE_ACCESSOR,
                    useExisting: forwardRef(function () { return OnsSearchInput_1; }),
                    multi: true,
                }
            ]
        }),
